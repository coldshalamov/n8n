  ...
  return (
    <RDialog.Root open={open} onOpenChange={onOpenChange}>
      <RDialog.Portal>
        ...
        <RDialog.Content
          className={clsx(
            'fixed left-1/2 top-1/2 z-50 w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-line bg-surface text-ink shadow-elevated data-[state=open]:animate-fade-in',
            SIZE_CLASS[size],
          )}
        >
